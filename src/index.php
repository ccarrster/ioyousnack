...
for (index = 0; index < users.length; ++index) {
	...
	document.write('<div id="nomtop'+index+'" style="background-size:100px 100px;position:absolute; width:100px; height:60px; background-image:url(\'eaters/'+users[index].image+'\'); top:0px; left:0px;"></div>');
	document.write('<div id="nombottom" style="background-size:100px 100px;position:absolute; width:100px; height:40px; background-image:url(\'eaters/'+users[index].image+'\'); background-position:0px -60px; top:60px; left:0px;"></div>');
	document.write('</div>');
...
for (index = 0; index < money.length; ++index) {
	...
	document.write('<div style="position:relative;">');
	document.write('<img id="pay'+index+'" width="100" style="width:100px; position:absolute;" src="money/'+money[index].image+'"/>');
	document.write('</div>');
